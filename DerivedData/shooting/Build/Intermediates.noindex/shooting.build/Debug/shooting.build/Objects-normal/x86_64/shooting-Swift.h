...
#ifndef SHOOTING_SWIFT_H
#define SHOOTING_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="shooting",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8shooting11AppDelegate")
...
SWIFT_CLASS("_TtC8shooting14ViewController")
@interface ViewController : NSViewController
@property (nonatomic, weak) IBOutlet NSImageView * _Null_unspecified ship;
- (void)viewDidLoad;
- (void)viewDidAppear;
