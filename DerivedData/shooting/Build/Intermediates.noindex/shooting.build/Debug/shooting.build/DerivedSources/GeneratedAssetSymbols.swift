...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let ship = DeveloperToolsSupport.ImageResource(name: "ship", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "ship" asset catalog image.
    static var ship: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .ship)
#else
        .init()
